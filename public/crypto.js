...
function generateKey(alg, scope) {
  ...
  function importPublicKey(pemKey, alg) {
    return new Promise(function(resolve) {
      var importer = crypto.subtle.importKey("spki", convertPemToBinary(pemKey), alg, true, ["encrypt"])
  ...
  function importPrivateKey(pemKey, alg) {
    return new Promise(function(resolve) {
      var importer = crypto.subtle.importKey("pkcs8", convertPemToBinary(pemKey), alg, true, ["sign"])
      importer.then(function(key) {
        resolve(key)
      })
    })
